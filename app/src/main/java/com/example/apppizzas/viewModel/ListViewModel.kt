...
class ListViewModel(application: Application) : AndroidViewModel(application) {
    ...
    var pizza_cuatroquesos: PizzaModel =
        PizzaModel("4 Quesos", mutableListOf("Tomate", "Queso1", "Queso2", "Queso3", "Queso4"))
    var pizza_carnivora: PizzaModel =
        PizzaModel("Carnivora", mutableListOf("Tomate", "Queso", "Pepperoni", "Carne picada"))
    var pizzas_disponibles =
        arrayListOf<PizzaModel>(pizza_margarita, pizza_carnivora, pizza_cuatroquesos)
